...
12. [Phase 4: 応募手続き](#12-phase-4-応募手続き)
13. [Phase 5: Bicep / CI/CD 生成](#13-phase-5-bicep--cicd-生成)
14. [Phase 6: 採択後管理](#14-phase-6-採択後管理)
...
flowchart TD
    ...
    IaC --> Phase6[Phase 6: post-award<br/>採択後管理]
...
```
Pre  ⏸️→ Phase 0 ⏸️→ Phase 1 → Phase 1b ⏸️→ Phase 2 → Phase 3 ⏸️→ Phase 3b ⏸️→ Phase 4 → Phase 5 → Phase 6
```
